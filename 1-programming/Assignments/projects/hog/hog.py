...
def is_always_roll(strategy, goal=GOAL):
    ...
    """
    # BEGIN PROBLEM 7
    i, j, strategy_result = 0, 0, strategy(0,0)
    while i < goal:
        while j < goal: 
            if strategy_result != strategy(i, j):
                return False
            j += 1
        i += 1
        j = 0
...
def final_strategy(score, opponent_score):
    ...
    *** YOUR DESCRIPTION HERE ***
    ...
    # BEGIN PROBLEM 12
    if 100 - score > 8:
        return square_strategy(score, opponent_score, 8, 6)
    else:
        return square_strategy(score, opponent_score, GOAL - score, 2)
