...
class Coin:
    ...
    def worth(self):
        ...
        increase = max(0, age - 50)
        return increase + self.cents
...
def two_list(vals, counts):
    ...
    """
    lst1 = Link.empty
    lists = zip(reversed(vals), reversed(counts))
    for l in lists:
        for i in range(l[1]):
            lst2 = Link(l[0], lst1)
            lst1 = lst2
...
class VirFib():
    ...
    def next(self):
        ...
        next_fib = VirFib(self.value + self.previous)
